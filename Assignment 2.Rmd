...
All models show a negative skew in the distribution of test error rates (TER), while the linear probability model (`lm`) shows the greatest range of TER variance that is observered in the models and largest median TER.
